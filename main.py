...
# #botao plot
# btn_plot = tk.Button(button_frame, text="Plot", command = plot_l)
...
# def plteval():
#     pltev = plotloadmodel.Plotmodel(ev)
#     pltev.plot()

# #botao plot_avaliar
# btn_plteval = tk.Button(button_frame, text="Plot Avaliar", command = plteval)
# btn_plteval.pack(pady=5)
